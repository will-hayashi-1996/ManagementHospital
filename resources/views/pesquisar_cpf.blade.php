...
@section('content')
 ...
 <div class="mb-3">
        ...
        <div style="position: absolute; top: 6%; left: 45%;" class="mb-3">
            ...
            <p class="pb-3" style="font-weight: bold;font-size: 18px;">Pesquisa de Médico por CPF</p>

        </div>

        <form  method="get" action="{{ route('pesquisar-cpf') }}" style="width: 50%; margin-left: auto; margin-right: auto; ">
                @csrf
                <label for="name" class="form-label">CPF do Médico</label>
